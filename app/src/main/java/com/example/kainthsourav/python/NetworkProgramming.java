...
public class NetworkProgramming extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_network_programming);
        WebView Helloworld_webview=(WebView)findViewById(R.id.adv_net);
        Helloworld_webview.getSettings().setJavaScriptEnabled(true);
        Helloworld_webview.loadUrl("file:///android_asset/Basic/python_networking.html");
    }
