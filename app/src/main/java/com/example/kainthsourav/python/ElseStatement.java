...
public class ElseStatement extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_else_statement);
        WebView Helloworld_webview=(WebView)findViewById(R.id.basic_else);
        Helloworld_webview.getSettings().setJavaScriptEnabled(true);
        Helloworld_webview.loadUrl("file:///android_asset/Basic/python_if_else.html");
    }
