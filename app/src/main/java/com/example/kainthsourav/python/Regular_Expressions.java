...
public class Regular_Expressions extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_regular__expressions);
        WebView Helloworld_webview=(WebView)findViewById(R.id.adv_exp);
        Helloworld_webview.getSettings().setJavaScriptEnabled(true);
        Helloworld_webview.loadUrl("file:///android_asset/Basic/python_reg_expressions.html");
    }
