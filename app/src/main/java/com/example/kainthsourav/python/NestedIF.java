...
public class NestedIF extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView Helloworld_webview=(WebView)findViewById(R.id.basic_nested);
        Helloworld_webview.getSettings().setJavaScriptEnabled(true);
        Helloworld_webview.loadUrl("file:///android_asset/Basic/nested_if_statements_in_python.html");
