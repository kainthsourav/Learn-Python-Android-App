...
public class Filesio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filesio);
        WebView Helloworld_webview=(WebView)findViewById(R.id.basic_io);
        Helloworld_webview.getSettings().setJavaScriptEnabled(true);
        Helloworld_webview.loadUrl("file:///android_asset/Basic/python_files_io.html");
    }
