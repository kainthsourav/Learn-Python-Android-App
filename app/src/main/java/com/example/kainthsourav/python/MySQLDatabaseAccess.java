...
public class MySQLDatabaseAccess extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_my_sqldatabase_access);
        WebView Helloworld_webview=(WebView)findViewById(R.id.adv_sql);
        Helloworld_webview.getSettings().setJavaScriptEnabled(true);
        Helloworld_webview.loadUrl("file:///android_asset/Basic/python_database_access.html");
    }
