...
public class Overview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView Helloworld_webview=(WebView)findViewById(R.id.basic_Overview);
        Helloworld_webview.getSettings().setJavaScriptEnabled(true);
        //Helloworld_webview.loadUrl("file:///android_asset/Basic/python_overview.html");
        Helloworld_webview.loadUrl("www.facebook.com");
    }
