...
public class loopss extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_loopss);
        WebView Helloworld_webview = (WebView) findViewById(R.id.Loo);
        Helloworld_webview.getSettings().setJavaScriptEnabled(true);
        Helloworld_webview.loadUrl("file:///android_asset/Loops.html");
    }
